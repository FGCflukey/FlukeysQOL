...
local qolSprayDistribTable = {
    "Base.SpraycanWhite",        2.0,
    "Base.SpraycanBlack",        2.0,
    "Base.SpraycanGray",         2.0,
    "Base.SpraycanDarkGray",     2.0,
    "Base.SpraycanRed",          2.0,
    "Base.SpraycanBlue",         2.0,
    "Base.SpraycanGreen",        2.0,
    "Base.SpraycanYellow",       2.0,
    "Base.SpraycanOrange",       2.0,
    "Base.SpraycanPurple",       2.0,
    "Base.SpraycanPastelBlue",   2.0,
    "Base.SpraycanPastelPink",   2.0,
    "Base.SpraycanPastelGreen",  2.0,
    "Base.SpraycanPastelYellow", 2.0,
    "Base.SpraycanMauve",        2.0,
    "Base.SpraycanBrown",        2.0,
    "Base.SpraycanTan",          2.0,
    "Base.SpraycanOlive",        2.0,
    "Base.SpraycanForestGreen",  2.0,
